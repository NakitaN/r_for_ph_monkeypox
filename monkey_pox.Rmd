...
We will be using the monkeypox case rate, population denominator and region data set to help us find the difference betwen monkeypox cases by region in the EU.
Is there a difference between country level monkeypox case rates by certain demographic factors?
We will use the monkeypox case, poplation denominator and census data to see if there is a difference between country level case rates based on certain demographic factors.
