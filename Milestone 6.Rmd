...
The table 1 shows the case rates in different European regions between the months of May and August 2022. Western Europe had the highest case rates in the month of July.
```{r}
plot_ly(res_size, 
        x = ~month, 
        y = ~size_cat_rate, 
